                ...
                <div className="contact__wrapper">
                    <div className="contact__detail--wrapper">
                        ...
                        <div className="button__wrapper">
                            <a href="mailto:contact@hansmaasdevine.be" target="__blank" className="about__contact--button contact__button contact__button--prim button__color">E-mail</a>
                            <a href="tel:+32499103827" className="about__contact--button contact__button contact__button--sec button__color--sec">Message</a>
                        </div>
                    </div>
                </div>
                <div className="bottom">
                    <div className="bottom__left">
                        <a href="https://www.instagram.com/maasdesign_studios/" target='__blank' className="social social__contact">
                            <img src="../../instagramwhite.svg" alt="icon of instagram" className='social__icon--instagram' />
                            <p>Instagram</p>
                        </a>
                        <a href="https://www.behance.net/hansmaas" target='__blank' className="social social__contact">
                            <img src="../../behancewhite.svg" alt="icon of behance" className='social__icon--behance' />
                            <p>Behance</p>
                        </a>
                        <a href="https://github.com/hansmaas123" target='__blank' className="social social__contact">
