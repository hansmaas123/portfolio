                ...
                <div className="contact__wrapper">
                    <div className="contact__detail--wrapper">
                        ...
                        <div className="button__wrapper">
                            <a to={''} className="about__contact--button contact__button contact__button--prim button__color">E-mail</a>
                            <a to={''} className="about__contact--button contact__button contact__button--sec button__color--sec">Message</a>
                        </div>
                    </div>
                </div>
